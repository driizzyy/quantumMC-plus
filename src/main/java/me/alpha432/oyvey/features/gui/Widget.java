...
public class Widget
    ...
    public void drawScreen(GuiGraphics context, int mouseX, int mouseY, float partialTicks) {
        ...
        int baseColor = ClickGuiModule.getInstance().rainbow.getValue() ? ColorUtil.rainbow(ClickGuiModule.getInstance().rainbowHue.getValue()).getRGB() : color;
        
        // Draw shadow effect (professional look)
        context.fill(this.x + 1, this.y, this.x + this.width + 1, this.y + 1, 0x22000000);
        context.fill(this.x, this.y + this.height - 6, this.x + this.width, this.y + this.height - 5, 0x22000000);
        
        // Draw main header background
        context.fill(this.x, this.y - 1, this.x + this.width, this.y + this.height - 6, baseColor);
        
        // Draw border accent
        context.fill(this.x, this.y - 1, this.x + 1, this.y + this.height - 6, 0xFF000000);
        
        if (this.open) {
            RenderUtil.rect(context, this.x, (float) this.y + 12.5f, this.x + this.width, (float) (this.y + this.height) + totalItemHeight, 0x88000000);
        }
